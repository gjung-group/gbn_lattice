...
t2_kaxiras = tkaxirasParamsCombineAAandAB(dist2,theta12a,theta21a) ;
...
t2_kaxiras = tkaxirasParamsCombineAAandAB(dist2,theta12b,theta21b) ;
...
habp  =  habp  +  tkaxirasParamsCombineAAandAB([dif2b;cz],theta12b,theta21b) .* exp( 1j*(dot(kv,dif2b) )) ;
...
hbap  =  hbap  +  tkaxirasParamsCombineAAandAB([dif2c;cz],theta12a,theta21a) .* exp( 1j*(dot(kv,dif2c) )) ;
