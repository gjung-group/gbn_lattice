function hkdval=getHkdForMap_KoshinoGlobal(V0_pi, V0_sigma, r0, DFTVec, dvecM, element, realOrImag, N, zdist)
...
t2_kaxiras = tmayouGlobalWithpppi(dif2a,cz,V0_sigma,V0_pi, r0);
...
habp  =  habp  +  tmayouGlobalWithpppi(dif2b,cz,V0_sigma,V0_pi, r0) .* exp( 1j*(dot(kv,dif2b) )) ;
...
hbap  =  hbap  +  tmayouGlobalWithpppi(dif2c,cz,V0_sigma,V0_pi, r0) .* exp( 1j*(dot(kv,dif2c) )) ;
