...
% New 3.1
V0_sigma = 1.3425; % AAp 1.3428
%V0_sigma = 0.9024; % ABp 0.9060
%V0_sigma = 1.3111; % BAp 1.3153
%V0_sigma = 0.8980; % BBp 0.9008
...
subplot(1,3,1);
scatter(dvec(:,1), dvec(:,2), 100, DFTVec,"filled",Marker="square");
xlim([0,1])
ylim([0,sqrt(3)])
title("DFT")
colorbar
subplot(1,3,2);
scatter(dvec(:,1), dvec(:,2), 100, hkdval,"filled",Marker="square");
title("Fit")
xlim([0,1])
ylim([0,sqrt(3)])
colorbar
...
scatter(dvec(:,1), dvec(:,2), 100, diff,"filled",Marker="square");
xlim([0,1])
ylim([0,sqrt(3)])
colorbar
title("Diff")
