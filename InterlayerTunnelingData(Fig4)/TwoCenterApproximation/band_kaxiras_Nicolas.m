...
habp  =  habp  +  tkaxirasParamsFlipV3([dif2b;cz],theta12b,theta21b) .* exp( 1j*(dot(kv,dif2b) )) ;
...
% including V9, sublattice independent using AB data, abrupt 4.5
V0_sigma_1 =1.1755;
V0_sigma_2 =  1.1613;

% including V9, sublattice independent using AB data, unconstrained
V0_sigma_1 =1.1097;
V0_sigma_2 =  1.1002;



% including V12, sublattice independent using AB data, abrupt 4.5
V0_sigma_1 =1.1720;
V0_sigma_2 =  1.1559;
...
% including V12, sublattice independent using AB data, unconstrained
V0_sigma_1 =1.1198;
V0_sigma_2 =  1.1100;
...
% including V6, sublattice independent using AB data, abrupt 2.5
V0_sigma_1 =  1.0073;
V0_sigma_2 = 1.0066;

% including V12, sublattice independent using AB data, abrupt 2.5
V0_sigma_1 =  1.0074;
V0_sigma_2 = 1.0067;


% including V12, sublattice independent using AB data, abrupt 5.0
V0_sigma_1 =  1.1294;
V0_sigma_2 = 1.1163;
...
% including V12, sublattice independent using AB data, unconstrained, N=15,
% corrected v sign
V0_sigma_1ABp =1.1200;
V0_sigma_1BAp =1.1195;
V0_sigma_2 =  1.1100;
...
%  plot(kvec(3,:)*const,emod(:,ndim/2),'*')
  ...
  % plot(kvec(3,:)*const,emod(:,ndim/2),kvec(3,:)*const,emod(:,ndim/2-1))
  % plot(kvec(3,:)*const,emod(:,ndim/2+1),kvec(3,:)*const,emod(:,ndim/2+2)) 
   plot(kvec(3,:)*const,emod(:,ndim/2-1),"g-")
   plot(kvec(3,:)*const,emod(:,ndim/2),"g-")
   plot(kvec(3,:)*const,emod(:,ndim/2+1),"g-") 
   plot(kvec(3,:)*const,emod(:,ndim/2+2),"g-")
