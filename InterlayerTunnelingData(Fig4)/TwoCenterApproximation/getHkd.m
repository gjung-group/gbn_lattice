function hbapMinhbapDFTSum=getHkd(V0_pi, V0_sigma, r0, DFTVec, dvecM, element, realOrImag, N)
...
hbapMinhbapDFT = abs(val - DFT) ;
hbapMinhbapDFTSum = hbapMinbapDFTSum + hbapMinhbapDFT;

end

hbapMinhbapDFTSum = hbapMinhbapDFTSum/length(DFTVec);
