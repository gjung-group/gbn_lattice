            ...
            if temp_dis(k) < cut && ((temp_disx(k) ~= 0) || (temp_disy(k) ~= 0) || (temp_disz ~= 0))
                if pos(i,4) == pos(j,4) && pos(i,5) == 3 && pos(j,5) == 3
                    ...
                    if pos(i,6) == 1 && abs(temp_disx(k)) < aG/2-0.001 && temp_dis(k) < a_cc+0.1*a_cc && temp_dis(k) > a_cc-0.1*a_cc
                        HamHopping(i,j) = HamHopping(i,j)+delta1*exp(1i*(kx*temp_disx(k)+ky*temp_disy(k)))*exp(-3.37*(R(4)-r0)/r0);
                    elseif pos(i,6) == 1 && temp_disx(k) > 0 && temp_dis(k) < a_cc+0.1*a_cc && temp_dis(k) > a_cc-0.1*a_cc
                        HamHopping(i,j) = HamHopping(i,j)+delta2*exp(1i*(kx*temp_disx(k)+ky*temp_disy(k)))*exp(-3.37*(R(4)-r0)/r0);
                    elseif pos(i,6) == 1 && temp_disx(k) < 0 && temp_dis(k) < a_cc+0.1*a_cc && temp_dis(k) > a_cc-0.1*a_cc
                        HamHopping(i,j) = HamHopping(i,j)+delta3*exp(1i*(kx*temp_disx(k)+ky*temp_disy(k)))*exp(-3.37*(R(4)-r0)/r0);
                ...
                elseif pos(i,4) == pos(j,4) && not(pos(i,5) == 3 && pos(j,5) == 3)
                    ...
                    if pos(i,6) == 3 && abs(temp_disx(k)) < aG/2-0.001 && temp_dis(k) < a_cc+0.1*a_cc && temp_dis(k) > a_cc-0.1*a_cc
                        HamHopping(i,j) = HamHopping(i,j)+delta1_BN*exp(1i*(kx*temp_disx(k)+ky*temp_disy(k)))*exp(-3.37*(R(4)-r0)/r0);
                    elseif pos(i,6) == 3 && temp_disx(k) > 0 && temp_dis(k) < a_cc+0.1*a_cc && temp_dis(k) > a_cc-0.1*a_cc
                        HamHopping(i,j) = HamHopping(i,j)+delta2_BN*exp(1i*(kx*temp_disx(k)+ky*temp_disy(k)))*exp(-3.37*(R(4)-r0)/r0);
                    elseif pos(i,6) == 3 && temp_disx(k) < 0 && temp_dis(k) < a_cc+0.1*a_cc && temp_dis(k) > a_cc-0.1*a_cc
                        HamHopping(i,j) = HamHopping(i,j)+delta3_BN*exp(1i*(kx*temp_disx(k)+ky*temp_disy(k)))*exp(-3.37*(R(4)-r0)/r0);
